...
$BackupDir = if ($BackupDir -ne "") { Join-Path $BackupDir "ConditionalAccess" } else { [System.IO.Path]::GetFullPath((Join-Path $PSScriptRoot "..\export\GoldenTenant_Backup\ConditionalAccess")) }
