...
$BackupDir = if ($BackupDir -ne "") { Join-Path $BackupDir "CompliancePolicies" } else { [System.IO.Path]::GetFullPath((Join-Path $PSScriptRoot "..\export\GoldenTenant_Backup\CompliancePolicies")) }
