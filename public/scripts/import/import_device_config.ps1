...
$BackupDir = if ($BackupDir -ne "") { Join-Path $BackupDir "DeviceConfigurations" } else { [System.IO.Path]::GetFullPath((Join-Path $PSScriptRoot "..\export\GoldenTenant_Backup\DeviceConfigurations")) }
