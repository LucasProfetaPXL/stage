...
$BackupDir = if ($BackupDir -ne "") { Join-Path $BackupDir "PowerShellScripts" } else { [System.IO.Path]::GetFullPath((Join-Path $PSScriptRoot "..\export\GoldenTenant_Backup\PowerShellScripts")) }
