...
$BackupDir = if ($BackupDir -ne "") { Join-Path $BackupDir "SecurityBaselines" } else { [System.IO.Path]::GetFullPath((Join-Path $PSScriptRoot "..\export\GoldenTenant_Backup\SecurityBaselines")) }
