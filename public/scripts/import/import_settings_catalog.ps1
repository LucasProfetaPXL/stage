...
$BackupDir = if ($BackupDir -ne "") { Join-Path $BackupDir "SettingsCatalog" } else { [System.IO.Path]::GetFullPath((Join-Path $PSScriptRoot "..\export\GoldenTenant_Backup\SettingsCatalog")) }
